...
not met with a helpful message.  
...
gflags.DEFINE_integer('log_level', 1, 'Valid options 0 (quiet), 1 (info), 2 (debug)')
...
QUIET = 0  # INFO level -> print message to stderr
...
def init_flags(argv = None):
    """ Call this in your main to setup logging level. """
    ...
    try:
        ...
        sys.exit(1)
    set_log_level(gflags.FLAGS.log_level)
